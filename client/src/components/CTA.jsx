...
function CTA() {
  return (
    <div className="max-w-5xl my-4 mx-2 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30">
      <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF]">
        ...
        <p className="text-slate-500 mt-2 max-w-lg max-md:text-sm">
          leading social media marketplace that link brands with customers
        </p>
        <button
          type="button"
